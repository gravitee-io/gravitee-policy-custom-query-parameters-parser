...
@DeployApi("/apis/v2/api.json")
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class CustomQueryParametersParserPolicyV3IntegrationTest extends AbstractGatewayTest {
    ...
    public void should_preserve_query_params_and_extract_them_properly(
        ...
        executeTest("/test", query, expectedQueryParameters, client);
    }

    protected void executeTest(String requestUri, String query, MultiValueMap<String, String> expectedQueryParameters, HttpClient client)
        throws InterruptedException {
        wiremock.stubFor(get("/team" + query).willReturn(ok()));

        client
            .rxRequest(HttpMethod.GET, requestUri + query)
